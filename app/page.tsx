    ...
    <div className="flex flex-col">
      ...
      <section id="services" className="py-16 bg-muted/30 scroll-mt-16">
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <ServiceCard title={t("services.ga4.title")} description={t("services.ga4.description")} icon={BarChart3} />
            <ServiceCard title={t("services.cro.title")} description={t("services.cro.description")} icon={LineChart} />
            <ServiceCard
      ...
      <section id="about" className="py-16 scroll-mt-16">
        <div className="container">
          ...
          <div className="bg-muted/30 py-12 px-6 rounded-lg animate-in" style={{ animationDelay: "100ms" }}>
            <h3 className="text-2xl font-bold mb-6 text-center">{t("about.values.title")}</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-2 animate-in" style={{ animationDelay: "200ms" }}>
              ...
              <div className="space-y-2 animate-in" style={{ animationDelay: "300ms" }}>
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="h-6 w-6 text-primary shrink-0 mt-0.5" />
                  <div>
              ...
              <div className="space-y-2 animate-in" style={{ animationDelay: "400ms" }}>
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="h-6 w-6 text-primary shrink-0 mt-0.5" />
                  <div>
              ...
              <div className="space-y-2 animate-in" style={{ animationDelay: "500ms" }}>
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="h-6 w-6 text-primary shrink-0 mt-0.5" />
                  <div>
      ...
      <section id="contact" className="py-16 bg-muted/30 scroll-mt-16">
        <div className="container">
          ...
          <div className="max-w-md mx-auto text-center">
            <div className="bg-card p-8 rounded-lg shadow-sm border animate-in" style={{ animationDelay: "100ms" }}>
